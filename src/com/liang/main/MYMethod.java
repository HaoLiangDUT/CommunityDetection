...
public class MYMethod {
    ...
    public void runONGraph() throws IOException {
        ...
        */
        ...
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File("./result/20170713.txt"))));
        ...
        while(!arrayListNodes.isEmpty()){
           ...
           // Map.Entry<Integer,Double> map = listJu.get(0);
            ...
            System.out.println("resultPvalue="+ qualityFunction.calculate(resultSet));
            //System.out.println("resultSize="  + resultSet.size());

            if(resultSet != null) {
                if(qualityFunction.calculate(resultSet) < Math.exp(2000))
...
//                    }
        ...
        // 结果去冗余
        BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File("./result/20171122.txt"))));
